...
from app.api.api_v1.endpoints import auth, users, patient_records, alerts, notes, location, reminders, anomalies, thresholds
from app.api.api_v1.endpoints import messaging, simulator
